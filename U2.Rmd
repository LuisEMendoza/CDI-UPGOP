...
Resolver expresiones algebraicas y derivadas en Maxima es bastante sencillo. La interfaz es muy simple, y todo es con base en comandos escritos que no son complejos. Veamos cómo simplificar y resolver tres ejercicios de cierta dificultad.

Comenzamos:

1. Derivar $f(x)=7x^3-4x^2+8x-10$:

__Computadora__ Ejecutamos la aplicación, cuya pantalla de bienvenida es una pequeña ventana de bienvenida que podemos cerrar. Enseguida se nos muestra la interfaz, que contiene un guión bajo que parpadea, justo donde señala el cursor en la siguiente imagen:
...
__Móvil__ El procedimiento difiere solo un poco. 
